...
# Assignment: 3
# Due Date: 2024-05-6
# Description:  Implementing Queue, Enqueue and Front in static array
...
class Queue:
    ...
    def enqueue(self, value: object) -> None:
        ...
        if self._current_size == self._sa.length():
            # Double the size of the  static array queue
            self._double_queue()
    ...
    def dequeue(self) -> object:
        """
        Removes value from the front of a queue
        """
        if self.is_empty():
        ...
        self._front = (self._front + 1) % self._sa.length()  # Circular increment of _front
        self._current_size -= 1
        return value
